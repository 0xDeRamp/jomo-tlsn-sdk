...
export function wasm_bindgen__convert__closures__invoke0_mut__h3d3b0109ffcecabe(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h31a50d3be349b9ef(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6dbc9a4e424d4853(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4f44922a9ea9bc39(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h281ee8c2a52664ea(a: number, b: number, c: number, d: number): void;
